...
namespace EntityFramework22Application.Model
{
    public partial class AdventureWorksContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer(@"Server=(localdb)\mssqllocaldb;Database=Demo.DataSeeding;Trusted_Connection=True;ConnectRetryCount=0");
        }
        ...
        protected void OnSeeding(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Employee>().HasData(
                new Employee { EmployeeId = 1, FirstName = "John", LastName = "Orson"},
